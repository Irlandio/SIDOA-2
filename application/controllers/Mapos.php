...
class Mapos extends CI_Controller {
    ...
    public function index() {
        ...
        $this->data['usuario'] = $this->mapos_model->getById($this->session->userdata('id'));
         $this->data['results_Usuarios'] = $this->mapos_model->getuser('usuarios','nome');
    ...
    public function verificarLogin(){
        ...
        if ($this->form_validation->run() == false) {
            ...
            if($user){
                ...
                if($user->bloqueio == '1' && date('H') < '24' && date('H') >= '0') 
                {
                    ...
                    $json = array('result' => false, 'message' => 'Usuário não liberado pelo administrador.');
                    echo json_encode($json);                    
                }}
                else{
