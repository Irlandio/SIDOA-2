    ...
    function adicionar(){  
        ...
        {     
            ...
            $this->encryption->initialize(array('driver' => 'mcrypt'));
                    ...
                    switch ($this->input->post('funcao'))
                    {		    
                        case '1':	     $funcao = 'Operador de telemarketing';	break;    
                        case '3':	     $funcao = 'Operador Virtual';	break;  
                        case '5':	     $funcao = 'Supervisão';	break;  
                        case '7':	     $funcao = 'Administrativo';	break;  
                        case '9':	     $funcao = 'Administrador de Sistema';	break;	
                    }
            ...
            $data = array(
					...
					'conta_Usuario' => $this->input->post('funcao'),
					'celular' => $funcao,
        ...
        $this->data['usuario'] = $this->usuarios_model->getById($this->session->userdata('id'));
        $this->data['result_cidades'] = $this->usuarios_model->get2('cidade');        
        ...
        { 
            ...
            $senha = $this->input->post('senha'); 
                    ...
                    {		    
                        case '1':	     $funcao = 'Operador de telemarketing';	break;    
                        case '3':	     $funcao = 'Operador Virtual';	break;     
                        case '4':	     $funcao = 'Operador Virtual';	break;  
                        case '5':	     $funcao = 'Supervisão';	break;  
                        case '7':	     $funcao = 'Administrativo';	break;  
                        case '9':	     $funcao = 'Administrador de Sistema';	break;	
                    }
            if($senha != null){
                ...
                $data = array(
                        ...
                        'senha' => $senha,
                        'conta_Usuario' => $this->input->post('funcao'),
                        'celular' => $this->input->post('funcao'),
