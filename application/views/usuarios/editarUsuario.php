...
</script><div class="row-fluid" style="margin-top:0">
    <div class="span12">
            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formUsuario" method="post" class="form-horizontal" >
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="cpf" type="text" name="cpf"  maxlength="14" size="40" value="<?php echo $result->cpf; ?>"   onkeypress="formatar_mascara(this,'###.###.###-##')"/>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">                         
                           <select id="cidade" name="cidade" class="span2">
                            <option value = "<?php echo $result->cidade; ?>"><?php echo $result->cidade; ?></option>
...
-->
                    ...
                    <div class="control-group">
                        <label for="conta_Usuario" class="control-label">Função<span class="required">*</span></label>
                        <div class="controls">
                            <select id="funcao" name="funcao">   
                                <option value = "<?php echo $result->conta_Usuario; ?>"><?php echo $fun; ?></option> 
