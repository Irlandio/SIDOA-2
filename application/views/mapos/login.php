...
<head>
        <title>CiscoD</title><meta charset="UTF-8" />
    </head>
   <!-- <h5 style="text-align: center"> CiScoF (Controle de Informaçao e Suporte de controle Financeiro)</h5>
    ...
    <body>
        <div id="loginbox"  style="margin-top: 1PX; align-text: center">        
        ...
        <div id="notification" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-header">
            ...
            <h4 id="myModalLabel">CiscoD</h4>
          </div>
          <div class="modal-body">
            <h5 style="text-align: center">Os dados incorretos ou acesso bloqueado, por favor tente novamente!</h5>
          </div>
