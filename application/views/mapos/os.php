    ...
    $contAnterior = 0;
            ...
            //    if($selecionado == 1)
                 ...
                 //   $data_Previsao = date(('d/m/Y'),strtotime($r->data_Previsao));
                  ...
                  //  if($selecionado == 1) $cor = '#8A9B0F';
                      //  $core = '#9b1a0f';
                        ...
                        $TcancrExibe  =    number_format(str_replace(",",".",$cancel), 2, ',', '.');
                        $TdevrExibe  =    number_format(str_replace(",",".",$devol), 2, ',', '.');
               ...
               //     echo '<td>'.$r->idUsuarios.'</td>';
                    ...
                    echo '<td style="text-align:right;" ><span class="badge" style="background-color: '.$corCanc.'; border-color: '.$corCanc.'">R$ '.$TcancrExibe.'</span></td>';
                    echo '<td style="text-align:right;" ><span class="badge" style="background-color: '.$corDev.'; border-color: '.$corDev.'">R$ '.$TdevrExibe.'</span></td>';
...
<div id="modal-ausent" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="span12" id="divEditarVenda">
        <form action="<?php echo base_url() ?>index.php/os/ausente" method="post">
