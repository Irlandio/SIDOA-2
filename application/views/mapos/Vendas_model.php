...
class Vendas_model extends CI_Model {
    ...
    function getAgen($table,$fields,$id_Usuario,$idAusant,$i,$adm,$where='',$perpage=0,$start=0,$one=false,$array='array'){
    ...
    function getConc($table,$fields,$id_Usuario,$idAusant,$i,$adm,$where='',$perpage=0,$start=0,$one=false,$array='array'){
    ...
    //   $this->db->join('marcas','marcas.cidaade1Rota = clientes.cidadeD');
        $this->db->join('marcas','marcas.cidaade1Rota = clientes.cidadeD or marcas.cidaade2Rota = clientes.cidadeD or marcas.cidaade3Rota = clientes.cidadeD');
