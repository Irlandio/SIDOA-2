...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Ultimas Aferições</h5></div>
...
<div class="row-fluid" style="margin-top: 0">
    ...
    <div class="span12">
        ...
        <div class="widget-box">
            <div class="widget-title"><span class="icon"><i class="icon-signal"></i></span><h5>Estatísticas de Lançamentos no mês</h5></div>
            <div class="widget-content">
                <div class="row-fluid">
                    <div class="span12">
                    ...
                    if($rs->atendente_id ==  $r->idUsuarios  )
                    {
                        ...
                        switch ($status) 
                                {						    
                                    ...
                                    case 'doado':	    $doad[$i]++; $Tdoad[$i] += $valor_doar;
