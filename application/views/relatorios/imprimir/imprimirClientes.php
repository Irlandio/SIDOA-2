              ...
              <div class="span12">
                  <div class="widget-box">
                      <div class="widget-title">
                          <h4 style="text-align: center">Doadores</h4>
                      </div>
                  ...
                  <table class="table table-bordered">
                      <thead>
                          <tr>
                              ...
                              <th style="font-size: 1.2em; padding: 5px;">Bairro</th>
                              <th style="font-size: 1.2em; padding: 5px;">Cidade</th>
                      ...
                      <tbody>
                          ...
                          foreach ($clientes as $c) {
                                        ...
                                        foreach ($results_Bairro as $rb) 
                                            {              
                                                if($c->bairroD == $rb->idBairro){ $nomeBai = $rb->Bairro; }
                                            } 
                                        foreach ($results_Cidade as $rc) 
                                            {              
                                                if($c->cidadeD == $rc->idC){ $nomeCid = $rc->nome; }
                                            } 
                              $dataCadastro = date('d/m/Y', strtotime($c->dataCadastroD));
                              echo '<tr>';
